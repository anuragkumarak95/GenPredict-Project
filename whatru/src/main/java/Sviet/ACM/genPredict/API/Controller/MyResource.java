package Sviet.ACM.genPredict.API.Controller;
...
public class MyResource {
	...
	@RequestMapping(value="/API/flush",method = RequestMethod.DELETE,produces= MediaType.TEXT_PLAIN_VALUE)
    public String AllFlushProtocol(@RequestHeader("flushCode") String flushCode) {
